...
class PointFootRoughCfg(BaseConfig):
    class env:
        num_envs = 8192
        num_observations = 30
        num_privileged_obs = 30  # if not None a priviledge_obs_buf will be returned by step() (critic obs for assymetric training). None is returned otherwise
        num_actions = 6
    ...
    class asset:
        ...
        max_joint_velocity={"abad": 20, "hip": 20, "knee": 20} # [rad/s]
